...
async function savetoCrudCrud(event){
    ...
    try{
    const res= await axios.post('https://crudcrud.com/api/b985a7ed9ce74a499b318f5d4f32eaa1/asyncres',order)
    onscreen(order);
    }
...
window.addEventListener('DOMContentLoaded',async ()=>{
    try{
    const res=await axios.get('https://crudcrud.com/api/b985a7ed9ce74a499b318f5d4f32eaa1/asyncres')
...
async function Delete(id,table){
    try{
    const data= await axios.delete(`https://crudcrud.com/api/b985a7ed9ce74a499b318f5d4f32eaa1/asyncres/${id}`)
